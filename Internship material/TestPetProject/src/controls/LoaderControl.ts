...
export default class LoaderControl extends MainControl {
    ...
    private readonly colors = {
        ...
        dark_turquoise: 0x357376,
        lavender_dark: 0x6B5B95,
        cream: 0xFFF5E1,
    ...
    constructor() {
        super();
        const firstLayer: RoundRect = getRect(this.loaderWidth, this.loaderHeight, this.colors.lavender_dark);
        const secondLayer: RoundRect = getRect(this.loaderWidth - 8, this.loaderHeight - 8, this.colors.dark_turquoise);
        const thirdLayer: RoundRect = getRect(this.loaderWidth - 15, this.loaderHeight - 15, this.colors.cream);
        const forthLayer: RoundRect = getRect(this.loaderWidth - 22, this.loaderHeight - 22, this.colors.dark_turquoise);

        this.fill = getRect(this.loaderWidth, this.loaderHeight, this.colors.cream);
