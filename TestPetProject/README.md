...
- For the first launch you can copy symbols.json and symbols.png from resources/origin.assets to reseurses/assets/atlases or 
Publis symbols.tps  spriteshite using TexturePacker, if you update symbols you always need to generate a texture atlas using Texture Packer! It`s only appliable for symbols, all other assets is automaticaly exported
