...
import DesktopBetPanelScene from "app/scenes/subscenes/DesktopBetPanelScene";
...
import mainGameLayout, {treesLayout} from "app/scenes/MainGameScene.layout";
...
import desktopLayout from "app/scenes/DesktopLayout";
...
export default class MainGameScene extends BaseScene {
    ...
    async activate() {
        ...
        this.layoutManager.addLayout(...mainGameLayout.commonLayouts, mainGameLayout.layouts);
        this.layoutManager.addLayout(treesLayout)
